...
IMAGE_SIZE = [224, 224] # Must be changed depending on dataset
...
valid_path = './dataset/images/TEST'
...
res = ResNet50(input_shape=IMAGE_SIZE + [3], weights='imagenet', include_top=False)  # do not include head, transfer learning
